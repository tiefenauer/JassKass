...
package info.tiefenauer.jasskass.app.event
{
	 ...
	 */
	public class GoogleAuthEvent extends Event
	{
		...
		public function GoogleAuthEvent(type:String, accessToken:String, bubbles:Boolean=false, cancelable:Boolean=false){
